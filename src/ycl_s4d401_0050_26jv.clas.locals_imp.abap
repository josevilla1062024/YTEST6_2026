...
CLASS lcl_flights DEFINITION.
  ...
  PRIVATE SECTION.
    ...
    DATA standard_table TYPE STANDARD TABLE OF ys4d401_fli_26jv WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA sorted_table TYPE SORTED TABLE OF ys4d401_fli_26jv WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA hashed_table TYPE HASHED TABLE OF ys4d401_fli_26jv WITH UNIQUE KEY carrier_id connection_id flight_date.
...
CLASS lcl_flights IMPLEMENTATION.
  ...
  METHOD constructor.
    SELECT FROM ys4d401_fli_26jv FIELDS * INTO TABLE @standard_table.
    SELECT FROM ys4d401_fli_26jv FIELDS * INTO TABLE @sorted_table.
    SELECT FROM ys4d401_fli_26jv FIELDS * INTO TABLE @hashed_table.
