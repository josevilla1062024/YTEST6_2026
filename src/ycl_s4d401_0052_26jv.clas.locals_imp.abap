...
CLASS lcl_flights DEFINITION.
  ...
  PRIVATE SECTION.
    DATA connections TYPE SORTED TABLE OF ys4d401_fli_26jv WITH NON-UNIQUE KEY carrier_id connection_Id flight_date.
    DATA connections_sk TYPE SORTED TABLE OF ys4d401_fli_26jv WITH NON-UNIQUE KEY carrier_id connection_id flight_date
...
CLASS lcl_flights IMPLEMENTATION.
  ...
  METHOD constructor.
    SELECT FROM ys4d401_fli_26jv FIELDS * INTO TABLE @connections.
    SELECT FROM ys4d401_fli_26jv FIELDS * INTO TABLE @connections_sk.
  ENDMETHOD.
