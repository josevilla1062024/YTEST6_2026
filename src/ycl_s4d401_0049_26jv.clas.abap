CLASS ycl_s4d401_0049_26jv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_s4d401_0049_26jv IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT YS4D401_FLI_26JV FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table YS4D401_FLI_26JV| ).
