...
"! Flight Carrier - A factory logic ensures that there can only be one instance for each carrier ID.
CLASS lcl_carrier DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    "! @raising ycx_s4d401_0069_26jv | Instantiation failed - evaluate the exception text for details.
...
*    INTO ( @me->name, @me->currency_code ).
    ...
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE ycx_s4d401_0069_26jv
        EXPORTING
          textid     = ycx_s4d401_0069_26jv=>carrier_not_exist
*         previous   =
    ...
    IF sy-subrc <> 0.
      ...
      RAISE EXCEPTION TYPE ycx_s4d401_0069_26jv
        EXPORTING
          textid     = ycx_s4d401_0069_26jv=>carrier_no_read_auth
*         previous   =
          carrier_id = i_carrier_id.
